  ...
  <div>
    ...
    >
      <div class="flex justify-between my-2 p-4">
        ...
        <div>
          <input
            ...
            class="bg-light border w-3/4 rounded outline-none flex-1 p-3"
          />
        </div>
      </div>
      ...
      <table class="w-full items-center table-auto">
        ...
        <tbody
          v-if="application && application.count > 0"
          class="text-middey-text overflow-x-auto"
        >
          <tr
            v-for="(item, idx) in application.results"
          ...
          >
            ...
            <td class="px-3 py-5  leading-5 whitespace-nowrap flex justify-center">
              <router-link
