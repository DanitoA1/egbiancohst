<template>
  <div class="container relative w-11/12 mx-auto z-30">
    <div class="flex flex-row items-center justify-between my-6">
      ...
      <div
        ...
        "
      >
        <div class="hidden lg:flex flex-row mb-1 space-x-16 text-dark-blue">
        ...
        <div class="hidden lg:flex flex-row items-end space-x-16">
