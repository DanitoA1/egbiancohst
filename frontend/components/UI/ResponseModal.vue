...
<template>
  <section>
    ...
    ></div>
    <div
      class="z-10 p-5 booknow bg-white text-center flex flex-col justify-center items-center space-y-4 rounded-2xl transform transition duration-300"
      :class="isOpen ? '  block' : '   hidden'"
    >
      <div>
        <img
      ...
      <h3 class="text-[#201E1ECC] text-sm">
        {{ message }}
      </h3>
